      ...
      <div class="flex justify-between items-center">
        ...
        <div class="flex">
          <ul>
            ...
            <li class="font-bold">
              <i class="t2ico t2ico-filter text-2xl"></i>
            </li>
            <li class="font-bold">
              <i class="t2ico t2ico-setting text-2xl"></i>
            </li>
            <li class="font-bold">Add</li>
            <li class="font-bold">Save</li> -->
            <li
              v-for="action in actions"
              :key="action.name"
              @click="handleClickActions(action.name)"
            >
              <div v-if="action.name == meta.actions">
                <i
                  v-if="action.isIcon"
